...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .setDescription('Sunucu [Burada](https://discord.gg/JEN2UwZ) Tanıtıldı! \n\n 12 Saat Sonra Sunucunuzu Tekrardan Tanıtabilirsiniz. \n\n Sunucunu Tanıtabilmek İçin Beni [Ekle!](https://discordapp.com/oauth2/authorize?client_id=485110852739923969&scope=bot&permissions=268443710)')
  .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('604472795711143987').send(embed)
            });
