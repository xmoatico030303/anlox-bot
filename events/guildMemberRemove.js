...
module.exports = async member => {  
  ...
  const background = await Canvas.loadImage('https://cdn.discordapp.com/attachments/518547945482878978/587766964231995430/GULEGULE.png');
  ...
  const attachment = new Discord.Attachment(canvas.toBuffer(), 'Anlox.png');
